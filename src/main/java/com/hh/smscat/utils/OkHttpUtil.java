...
public class OkHttpUtil {
    ...
    public String sendBySync(Request request) {
        try {
            ...
            log.error("send {} to {} fail:"+e.getMessage(),request.method(),request.url());
        }
        return null;
    }
    ...
    public static void main(String[] args) {
        ...
        String result = "";
        //get
        result = OkHttpUtil.newInstance().sendBySync(new Request.Builder().url(url).get().build());
        //post
        ...
        //put
        result = OkHttpUtil.newInstance().sendBySync(new Request.Builder().url(url).put(RequestBody.create(okhttp3.MediaType.get(MediaType.APPLICATION_JSON_UTF8_VALUE), "{}")).build());
        //patch
